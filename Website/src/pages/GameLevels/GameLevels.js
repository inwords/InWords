                    ...
                    >
                        <Card>
                            <CardContent>
                                ...
                                <div>
                                    <StarIcon color={levelInfo.playerStars > 0 ? 'secondary' : 'disabled'} />
                                    <StarIcon color={levelInfo.playerStars > 1 ? 'secondary' : 'disabled'} />
                                    <StarIcon color={levelInfo.playerStars > 2 ? 'secondary' : 'disabled'} />
                                </div>
                            </CardContent>
                            <CardActions>
                                <Button
...
GameLevels.propTypes = {
    levelsInfo: PropTypes.arrayOf(PropTypes.shape({
