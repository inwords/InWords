...
proto.Dictionary.v2.GetWordsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.Dictionary.v2.WordsReply.toObject, includeInstance)
  };
...
proto.Dictionary.v2.GetWordsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.Dictionary.v2.WordsReply;
      reader.readMessage(value,proto.Dictionary.v2.WordsReply.deserializeBinaryFromReader);
      msg.addWords(value);
      break;
    default:
      reader.skipField();
...
proto.Dictionary.v2.GetWordsRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.Dictionary.v2.WordsReply.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.Dictionary.v2.WordsReply>}
 */
proto.Dictionary.v2.GetWordsRequest.prototype.getWordsList = function() {
  return /** @type{!Array<!proto.Dictionary.v2.WordsReply>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Dictionary.v2.WordsReply, 1));
};


/**
 * @param {!Array<!proto.Dictionary.v2.WordsReply>} value
 * @return {!proto.Dictionary.v2.GetWordsRequest} returns this
*/
proto.Dictionary.v2.GetWordsRequest.prototype.setWordsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.Dictionary.v2.WordsReply=} opt_value
 * @param {number=} opt_index
 * @return {!proto.Dictionary.v2.WordsReply}
 */
proto.Dictionary.v2.GetWordsRequest.prototype.addWords = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.Dictionary.v2.WordsReply, opt_index);
};
 ...
 * @return {!proto.Dictionary.v2.GetWordsRequest} returns this
 */
proto.Dictionary.v2.GetWordsRequest.prototype.clearWordsList = function() {
...
proto.Dictionary.v2.WordsReply.toObject = function(includeInstance, msg) {
  var f, obj = {
    userwordpairs: jspb.Message.getFieldWithDefault(msg, 1, 0),
...
/**
 * optional int32 UserWordPairs = 1;
 * @return {number}
 */
proto.Dictionary.v2.WordsReply.prototype.getUserwordpairs = function() {
 ...
 */
proto.Dictionary.v2.WordsReply.prototype.setUserwordpairs = function(value) {
 ...
 * @return {string}
 */
proto.Dictionary.v2.WordsReply.prototype.getWordforeign = function() {
 ...
 * @return {!proto.Dictionary.v2.WordsReply} returns this
 */
proto.Dictionary.v2.WordsReply.prototype.setWordforeign = function(value) {
 ...
 * @return {string}
 */
proto.Dictionary.v2.WordsReply.prototype.getWordnative = function() {
 ...
 * @return {!proto.Dictionary.v2.WordsReply} returns this
 */
proto.Dictionary.v2.WordsReply.prototype.setWordnative = function(value) {
