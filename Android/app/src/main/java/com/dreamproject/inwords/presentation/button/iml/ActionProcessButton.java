package com.dreamproject.inwords.presentation.button.iml;
...
import com.dreamproject.inwords.presentation.button.ProcessButton;
        ...
        void draw(Canvas canvas) {
            ...
            if (mRunning || (mFinishTime > 0)) {
                ...
                if (!mRunning) {
                    ...
                    float clearRadius = width / 2.0f * INTERPOLATOR.getInterpolation(pct);
