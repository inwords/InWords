...
import ru.inwords.inwords.authorisation.presentation.choose_method.ChooseSignMethodFragment
...
@Module
abstract class AuthorisationAndroidInjectorsModule {
    ...
    @ContributesAndroidInjector
    internal abstract fun chooseSignMethodFragmentInjector(): ChooseSignMethodFragment
}
