...
import ru.inwords.inwords.core.property.IntProperty
import ru.inwords.inwords.core.property.StringProperty
...
class LastAuthInfoProvider @Inject constructor(@Common private val sharedPreferences: SharedPreferences) {
    ...
    private var userIdInternal: String by StringProperty(PREFS_LAST_LOGGED_USER_ID, sharedPreferences) { "" }
    private var authMethodInternal: Int by IntProperty(PREFS_LAST_AUTH_METHOD, sharedPreferences) { AUTH_METHOD_NATIVE }
